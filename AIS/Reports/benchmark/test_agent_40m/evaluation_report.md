...
- **주입 결함(Mutants)**: 4대 연산자 기반 총 40개 뮤턴트
...
- Mutant Killed (TP): 40/40 Killed (100.0%)
- Precision: 100.00% | Recall: 100.00% | F1-Score: 100.00% | Accuracy: 100.00%
- 난이도별: Easy(14/14), Medium(17/17), Hard(9/9) Killed
```
...
| :--- | :---: | :---: |
| **생성된 TC 실행: Fail (결함 검출)**<br>*(Predicted Positive)* | **True Positive (TP) = 40**<br>*(Mutant Killed / 정상 검출)* | **False Positive (FP) = 0**<br>*(Broken Test / 오탐)* |
...
|---|---|:---:|:---:|:---:|
| **Precision (정밀도)** | $\frac{TP}{TP + FP} = \frac{40}{40 + 0}$ | **100.00%** | $\ge 90.0\%$ | **PASS** |
| **Recall (재현율 / Mutation Score)** | $\frac{TP}{TP + FN} = \frac{40}{40 + 0}$ | **100.00%** | $\ge 90.0\%$ | **PASS** |
...
|---|:---:|:---:|:---:|
| `arithmetic_operator` | 8개 | 8개 | **100.0%** |
| `boundary_change` | 15개 | 15개 | **100.0%** |
| `condition_negation` | 8개 | 8개 | **100.0%** |
| `return_value` | 9개 | 9개 | **100.0%** |

### 5.3 모듈별 분석
| 모듈명 | 전체 수 | 검출(Killed) | 검출률 |
|---|:---:|:---:|:---:|
| `dsutil` | 7개 | 7개 | **100.0%** |
| `humanize` | 6개 | 6개 | **100.0%** |
| `iterutils` | 6개 | 6개 | **100.0%** |
| `mathutil` | 7개 | 7개 | **100.0%** |
| `strutil` | 7개 | 7개 | **100.0%** |
| `validators` | 7개 | 7개 | **100.0%** |
